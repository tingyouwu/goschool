...
/**
 * @Decription 找师兄帮帮忙 适配器
 */
public class HelpAdapter extends BaseRecyclerViewMultiItemAdapter<ActionItem> {
    public HelpAdapter(Context context, List<ActionItem> data) {
        super(context,data);
